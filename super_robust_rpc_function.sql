-- ===================================================================
-- FUNÇÃO RPC SUPER ROBUSTA: CHECK-IN VIA QR CODE
-- ===================================================================
-- Esta versão tenta múltiplas estratégias de busca para garantir que funcione
-- ===================================================================
...
COMMENT ON FUNCTION checkin_by_qr_code(TEXT) IS 'Função RPC super robusta para check-in via QR code. Tenta múltiplas estratégias de busca para garantir compatibilidade. Uso: SELECT checkin_by_qr_code(''PLKTK909538'')';