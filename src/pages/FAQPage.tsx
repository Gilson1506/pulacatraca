...
const FAQPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-4 sm:mb-6">Guia Completo de Compra e Gestão de Ingressos - Pulakatraka</h1>

      <section className="space-y-3 sm:space-y-4 text-gray-700">
        <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Como funciona a compra de ingressos pelo Pulakatraka?</h2>
        ...
        <ol className="list-decimal pl-4 sm:pl-6 space-y-2">
          ...
          <li>Escolha a forma de pagamento: Estão disponíveis as seguintes opções: cartão de crédito, cartão de débito virtual da Caixa, PIX e PayPal.</li>
      ...
      <section className="space-y-4 text-gray-700 mt-8">
        ...
        <ul className="list-disc pl-6 space-y-1">
          ...
          <li>Tente outro cartão ou forma de pagamento como PIX;</li>
