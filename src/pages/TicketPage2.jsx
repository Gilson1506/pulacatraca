  ...
  return (
    <div className="flex flex-col items-center bg-[#f3eeec] p-5 min-h-screen">
        ...
        <div className="flex flex-1 bg-[url('/parte2backgraund.png')] bg-cover bg-center bg-no-repeat p-4 lg:p-8 justify-center items-center relative min-h-[300px] lg:min-h-0">
          ...
          <div className="flex flex-col items-center gap-4 lg:gap-6 text-center relative z-10 max-w-md">
          ...
          {/* Logo com QR */}
          <div className="absolute bottom-4 right-1 relative z-10">
            <img src="/logo-com-qr.png" alt="Logo com QR" className="w-41 h-41" />
          </div>
        </div>
        ...
        {/* Lado direito */}
        <div className="flex flex-col flex-[0.7] relative items-center justify-start p-3 text-white bg-[url('/parte1backgraund.jpg')] bg-cover bg-center">
          <div className="absolute inset-0 bg-black bg-opacity-20"></div>

          {/* Título QR */}
          <div className="relative text-lg lg:text-base font-bold mb-2 lg:mb-1 text-black">QR CODE</div>

          {/* QR Code maior - usa apenas o número do ingresso para o scanner */}
