...
const PolicyPage: React.FC = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Política de cancelamento e reembolso</h1>
      ...
      <section className="space-y-4 text-gray-700 mt-8">
        <h2 className="text-xl font-semibold text-gray-900">Observações importantes:</h2>
        <ul className="list-disc pl-6 space-y-2">
      ...
      <p className="mt-8 text-sm text-gray-500">Esta página será atualizada futuramente com mais detalhes.</p>
    </div>
  );
};
